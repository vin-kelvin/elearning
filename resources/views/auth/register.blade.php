            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="role" class="col-md-4 col-form-label text-md-end">{{ __('Registered As') }}</label>
                        ...
                        <div id="employee-number" class="row mb-3" style="display: none;">
                            <label for="employee_number" class="col-md-4 col-form-label text-md-end">{{ __('Employee Number') }}</label>
                            
                            <div class="col-md-6">
                                <input id="employee_number" type="text" class="form-control @error('employee_number') is-invalid @enderror" name="employee_number" value="{{ old('employee_number') }}" autocomplete="employee_number">
                        ...
                        {{-- Script ya kudisplay employee number field --}}
                        <script>
                            const roleSelect = document.getElementById('role');
                            const employeeNumberField = document.getElementById('employee-number');
                        
                            roleSelect.addEventListener('change', function() {
                                if (roleSelect.value === 'teacher') {
                                    employeeNumberField.style.display = '';
                                } else {
